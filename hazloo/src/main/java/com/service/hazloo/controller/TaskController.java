...
public class TaskController {
    ...
    public ResponseEntity<Task> updateTask(@PathVariable("id") Long id,@RequestBody TaskDTO request) {
    ...
    public ResponseEntity<List<Task>> filterTasksByParams(@RequestParam(value = "title", required =  false) String title,@RequestParam(value = "status", required =  false) String status,@RequestParam(value = "project", required =  false) Long project,@RequestParam(value = "user", required =  true) Long user) {
    ...
    public ResponseEntity<Task> solvedTask(@RequestBody SolvedTaskDTO request) {
